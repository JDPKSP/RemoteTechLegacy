        ...
        Target target
        {
            get
            {
                ...
                if (RefNode == null)
                {
                    ...
                    target.GUIListname = Prefix + RefBody.theName;
                }
                else
                {
                    ...
                    if (RefNode.IsBase)
                        target.GUIListname = Prefix + RefNode.ToString();
                    else
                    {
                        target.GUIListname = Prefix + RefNode.VesselName + " (" + RefNode.TypeName + ")";
                    }
                }
                return target;
            }
